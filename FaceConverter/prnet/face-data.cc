...
bool LoadFaceData(const std::string &datapath, FaceData *face_data)
{
    ...
    // Load face index data. 43867 indices in total.
    {
    ...
    // Load triangle data. 86906 *3(triangle vertices) indices in total.
    {
    ...
    // Loads corresponding uv(pixel) location for landmark points in an image. 68 *2(x,y) indices in total.
    {
    ...
    // Load canonical vertices, 43867 in total.
    {
